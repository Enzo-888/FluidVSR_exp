# train_GPSD_RB.py
# Adapted from train_GPSD.py for RayleighBenard VSR task.
#
# Supports single-GPU and multi-GPU (DDP via torchrun).
#
# Single GPU:
#   CUDA_VISIBLE_DEVICES=0 python train_GPSD_RB.py --core_path ...
#
# 4-GPU DDP:
#   CUDA_VISIBLE_DEVICES=0,5,6,7 torchrun --nproc_per_node=4 train_GPSD_RB.py --core_path ...
#
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset",          type=str,   default="rb")
    parser.add_argument("--core_path",        type=str,   default="./data/core_rb_1x128x128_latest.mat")
