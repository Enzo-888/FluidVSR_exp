# train_GPSD_KF256.py
# Adapted from train_GPSD_RB.py for KF256 (Kolmogorov Flow) VSR task.
#
# Key differences vs RB:
#   - img_size=256 (HR 256x256)
#   - core tensor from FTM_KF256
#
# Single GPU:
#   CUDA_VISIBLE_DEVICES=0 python train_GPSD_KF256.py --core_path ./data/core_kf256_1x256x256_XXXX.mat
#
# 4-GPU DDP:
#   CUDA_VISIBLE_DEVICES=1,2,3,4 torchrun --nproc_per_node=4 --master_port=29502 train_GPSD_KF256.py --core_path ./data/core_kf256_1x256x256_XXXX.mat
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset",          type=str,   default="kf256")
    parser.add_argument("--core_path",        type=str,   default="./data/core_kf256_1x256x256_latest.mat")
