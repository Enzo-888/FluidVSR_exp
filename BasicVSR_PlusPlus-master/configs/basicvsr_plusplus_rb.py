exp_name = 'basicvsr_plusplus_c64n7_rb_1ch_4x'
...
test_cfg  = dict(metrics=[], crop_border=0)   # metrics computed via eval_rb.ipynb

# ── Data paths ─────────────────────────────────────────────────────────────────
_hr_path = '/data/yc/dataset/RB/code/rayleigh-benard-32/data1/HR'
_lr_path = '/data/yc/dataset/RB/code/rayleigh-benard-32/data1/LR'
...
data = dict(
    ...
    val=dict(
        ...
        split='valid',
        num_samples=120,
        num_input_frames=None,     # full 100-frame sequence
        train_ratio=0.8,
        valid_ratio=0.1,
...
# Save at iter 5000 (early check) and iter 10000 (final), only 2 saves total
