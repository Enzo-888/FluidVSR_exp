"""Test RVRT on KF256 test split and save predictions.

Usage:
    CUDA_VISIBLE_DEVICES=1 python main_test_rvrt_kf256.py --checkpoint experiments/rvrt_kf256/20000_G.pth

Output (saved to experiments/rvrt_kf256/test_predictions/):
...
def main():
    ...
    dataset  = VideoRecurrentKF256Dataset(test_opt)
