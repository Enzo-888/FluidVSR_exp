"""Test RVRT on SW test split and save predictions.

Usage:
    CUDA_VISIBLE_DEVICES=1 python main_test_rvrt_sw.py --checkpoint experiments/rvrt_sw/20000_G.pth

Output (saved to experiments/rvrt_sw/test_predictions/):
...
def main():
    ...
    dataset  = VideoRecurrentSWDataset(test_opt)
