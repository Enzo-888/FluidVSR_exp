"""Train RVRT on SW VSR dataset.

Usage (4 GPUs):
    CUDA_VISIBLE_DEVICES=1,2,3,4 torchrun --nproc_per_node=4 --master_port=29504 main_train_rvrt_sw.py
...
from data.dataset_video_sw import VideoRecurrentSWDataset

# ── Config ────────────────────────────────────────────────────────────────────
CFG = dict(
    # data
    dataroot_gt  = '/data/yc/dataset/RB/code/shallow-water-32/data1/HR',
    dataroot_lq  = '/data/yc/dataset/RB/code/shallow-water-32/data1/LR',
    num_samples  = 200,
    ...
    # model (same architecture as RB, adjusted img_size for SW LR=64x64)
...
def main():
    ...
    train_dataset = VideoRecurrentSWDataset(train_opt)
