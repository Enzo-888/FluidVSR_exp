...
class VideoRecurrentKF256Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        lq = self.lr_seqs[seq_idx][start:start + T].copy()
        gt = self.hr_seqs[seq_idx][start:start + T].copy()
