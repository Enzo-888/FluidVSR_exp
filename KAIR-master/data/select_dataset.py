...
def define_Dataset(dataset_opt):
    ...
    elif dataset_type in ['videorecurrentrbdataset']:
        from data.dataset_video_rb import VideoRecurrentRBDataset as D

    elif dataset_type in ['videorecurrentkf256dataset']:
        from data.dataset_video_kf256 import VideoRecurrentKF256Dataset as D

    elif dataset_type in ['videorecurrentswdataset']:
        from data.dataset_video_sw import VideoRecurrentSWDataset as D
