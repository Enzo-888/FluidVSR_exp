"""
Test VRT on the SW dataset and save predictions.

Usage:
    python main_test_vrt_sw.py --opt options/vrt/011_train_vrt_videosr_sw.json \
                                  --checkpoint experiments/011_train_vrt_videosr_sw/models/200000_G.pth \
